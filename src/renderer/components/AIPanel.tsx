...
const styles: Record<string, React.CSSProperties> = {
  ...
  input: {
    flex: 1, padding: 8, borderRadius: 980, border: 'none', background: 'rgba(255,255,255,0.08)',
  ...
  chip: {
    ...
    color: 'rgba(255,255,255,0.85)', fontSize: 11, cursor: 'pointer', border: 'none', background: 'rgba(255,255,255,0.07)',
  },
